...
import { createEvaluation } from "@/app/dashboard/evaluaciones/actions";
    ...
    if (!activePeriod) return (
        <div className="flex justify-center items-center min-h-screen bg-gray-50 p-8">
            <div className="max-w-md text-center bg-white rounded-3xl shadow-xl p-10 border border-amber-100">
                ...
                <Link href="/dashboard/materias" className="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition-all">
                    ← Volver a materias
                </Link>
            </div>
        </div>
