        ...
        <div className="p-8 space-y-6 max-w-3xl">
            ...
            <div>
                ...
                <p className="text-slate-400 text-sm mt-1">
                    Carga masiva de docentes desde archivo CSV — se crean cuentas de usuario automáticamente
                </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
                ...
                <div className="bg-slate-900 rounded-xl p-4 overflow-x-auto">
                    ...
                    <pre className="text-emerald-400 text-xs font-mono whitespace-pre leading-relaxed">
                        {`nombre,apellido,email,numero_empleado,carrera_code,password
Carlos,Ramírez,c.ramirez@uptex.edu.mx,DOC001,ISC,uptx2026
María,González,m.gonzalez@uptex.edu.mx,DOC002,ISC,`}
                    </pre>
                </div>
            ...
            {result && (
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
                    ...
                    {result.success > 0 && result.errors.length === 0 && (
                        <div className="bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3">
                            <p className="text-sm text-emerald-700 font-bold flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4" /> Todos los docentes fueron importados correctamente
                            </p>
                        </div>
                    )}
                    ...
                    <div className="flex gap-3 pt-2">
                        <Link href="/admin/docentes" className="flex-1 text-center py-2.5 rounded-xl bg-blue-700 text-white text-sm font-bold hover:bg-blue-800 transition-all">
